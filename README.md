...
- 二维码登录网易云音乐
![登录页展示](docs/images/login-page.png)
- 首页好友同步与消息归档和unknown 歌曲最小字段贡献
![首页与好友列表展示](docs/images/home-page.png)
- 聊天记录查询与筛选
![聊天记录区展示](docs/images/records.png)
- 音乐关系分析与可视化
![音乐关系区单好友关系展示](docs/images/music-relation1.png)
![音乐关系区音乐社交展示](docs/images/music-relation2.png)
- 影子歌单生成
![影子歌单页展示](docs/images/shadow-playlist.png)
